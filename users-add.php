<?php
    ...
    $employees = include('database/show-users.php');
...
<head>
    ...
    <title>Cloth Craft - add employee</title>
                ...
                <div class="dashboard_content_main">
                    <div class="row">
                        <div class="column column-5">
                            <h1 class="section_header"> <i class="fa fa-plus"></i>Create employee</h1>
                        ...
                        <div class="column column-7">
                            <h1 class="section_header"> <i class="fa fa-list"></i> List of employees</h1>
